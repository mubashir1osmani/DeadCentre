...
var enemy_type = ["DangerTarget", "MediumTarget", "RareTarget", "EasyTarget"]
...
func _process(delta):
	...
	if sprite != null and sprite.texture != null:
		...
		print("Sprite or texture not found for target type: ", target_type)
